...
INSERT INTO apex_objeto_dependencias (proyecto, dep_id, objeto_consumidor, objeto_proveedor, identificador, parametros_a, parametros_b, parametros_c, inicializar, orden) VALUES (
	...
	'1832000173', --dep_id
	'2361', --objeto_consumidor
	'1832000191', --objeto_proveedor
	'premios_docencia', --identificador
	NULL, --parametros_a
	NULL, --parametros_b
	NULL, --parametros_c
	NULL, --inicializar
...
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'pruebas', --hijo_proyecto
	'1832000191', --hijo_objeto
	'premios_docencia', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'52'  --orden
);
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'pruebas', --hijo_proyecto
	'1832000196', --hijo_objeto
	'capacitacion', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'53'  --orden
);
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'pruebas', --hijo_proyecto
	'1832000198', --hijo_objeto
	'rrhh_investigacion', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'54'  --orden
);
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'pruebas', --hijo_proyecto
	'1832000200', --hijo_objeto
	'cursos_extension', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'55'  --orden
);
INSERT INTO apex_objeto_datos_rel_asoc (proyecto, objeto, asoc_id, identificador, padre_proyecto, padre_objeto, padre_id, padre_clave, hijo_proyecto, hijo_objeto, hijo_id, hijo_clave, cascada, orden) VALUES (
	...
	NULL, --padre_clave
	'pruebas', --hijo_proyecto
	'1832000202', --hijo_objeto
	'representacion', --hijo_id
	NULL, --hijo_clave
	NULL, --cascada
	'56'  --orden
);
