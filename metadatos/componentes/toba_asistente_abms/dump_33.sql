...
INSERT INTO apex_molde_operacion (proyecto, molde, operacion_tipo, nombre, item, carpeta_archivos, prefijo_clases, fuente, punto_montaje) VALUES (
	...
	'3501', --item
	'impresion_informe', --carpeta_archivos
	'_impresion_informe', --prefijo_clases
	'desempenio', --fuente
	'13'  --punto_montaje
);
...
FROM
	ficha as t_f
ORDER BY user_id', --cuadro_carga_sql
